...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admin__719FE4E803421507");
        ...
        {
            entity.HasKey(e => e.BlacklistId).HasName("PK__Blacklis__AFDBF438115AA35A");
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E13BB3D7AA4EF");
        ...
        {
            entity.HasKey(e => e.HospitalId).HasName("PK__Hospital__38C2E58F3D13DA3B");
        ...
        {
            entity.HasKey(e => e.IllnessId).HasName("PK__Illness__2BA575BB0C32B7AC");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231BC4164DEDBA");
        ...
        {
            entity.HasKey(e => e.InsuredId).HasName("PK__Insured__03C4A29B4FDBD3C6");
        ...
        {
            entity.HasKey(e => e.InsuredIllnessId).HasName("PK__InsuredI__67B6BD8B7A9F56B3");
        ...
        {
            entity.HasKey(e => e.InsuredPolicyId).HasName("PK__InsuredP__72634910B60BCE52");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A38349EF190");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__Policy__2E1339440412D473");

            entity.ToTable("Policy");

            entity.HasIndex(e => e.PolicyNumber, "UQ__Policy__46DA0157640816FE").IsUnique();
        ...
        {
            entity.HasKey(e => e.PolicyHolderId).HasName("PK__PolicyHo__0549D1CB196B67B0");
